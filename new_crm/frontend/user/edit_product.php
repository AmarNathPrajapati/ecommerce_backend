                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-3">Case Study</h1>
                            </div>
                            <!-- Actions -->
                    ...
                    <div class="card shadow border-0 mb-7 p-sm-5">
                        ...
                        <div class="form-box px-sm-5 mb-5">
                            ...
                            onsubmit="return showloader()" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="doc_name" class="form-label">Case Study Title</label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="file">Case Study File</label>
