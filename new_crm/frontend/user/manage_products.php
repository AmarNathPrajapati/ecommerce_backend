                                                                    ...
                                                                    <?php
                                                                            ...
                                                                            ?>
                                                                                <video width="400" style="height:200px; object-fit:cover;" controls>
                                                                                        <source src="../../documents/products/<?php echo $row["file"];?>" type="video/mp4">
                                                                                </video>
                                                                            
                                                                            <?php
                                                                            } else {
                                                                                ?>
                                                                                    <img style="object-fit:contian;"  src="../../documents/products/<?php echo $row["file"];?>" style="max-width:100%; height:200px; margin:auto; object-fit:cover;"alt="img">
                                                                                <?php
                                                                            }
