                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6 col-12 text-sm-end">
                                <div class="mx-n1">
                                    ...
                                    <a href="./new_case_study.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <span class=" pe-2">
            ...
            <main class="py-6 bg-surface-secondary">
                <div class="container-fluid">
                    ...
                    <div class="row g-5 mb-5" >
                        <?php 
                                $stmt="SELECT id,title,description,file,file_type,active,created_at FROM case_study WHERE deleted_at IS NULL ORDER BY created_at DESC";
                                                                    ...
                                                                    <?php
                                                                            ...
                                                                            ?>
                                                                                <video width="400" style="height:200px; object-fit:cover;" controls>
                                                                                        <source src="../../documents/case_study/<?php echo $row["file"];?>" type="video/mp4">
                                                                                </video>
                                                                            
                                                                            <?php
                                                                            } else {
                                                                                ?>
                                                                                    <img style="object-fit:contian;"  src="../../documents/case_study/<?php echo $row["file"];?>" style="max-width:100%; height:200px; margin:auto; object-fit:cover;"alt="img">
                                                                                <?php
                                                                            }
                                                                ...
                                                                <div class="col-12 mt-4 text-center ">
                                                                    ...
                                                                    <div class="mt-5">
                                                                        ...
                                                                        <div style="float: right;display:flex;">
                                                                            <form action="./edit_case_study.php" method="get"><input type="number" name="id" value="<?php echo $row["id"];?>" hidden> 
                                                                            ...
                                                                            <form action="../../backend/user/remove_case_study.php" method="post"><input type="number" name="id" value="<?php echo $row["id"];?>" hidden> <button class="btn btn-neutral text-danger p-2" style="font-size:12px;"><i class="bi bi-trash"></i></button></form>
                                                                        </div>
                                                                    </div>
