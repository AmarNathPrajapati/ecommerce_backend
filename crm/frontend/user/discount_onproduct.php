                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight">Manage Discount on Products</h1>
                            </div>
                            <!-- Actions -->
                            <div class="col-sm-6 col-12 text-sm-end">
                                <div class="mx-n1">
                                    ...
                                    <a href="./new_discount_product.php" class="btn d-inline-flex btn-sm btn-primary mx-1">
                                        <span class=" pe-2">
                                            <i class="bi bi-plus"></i>
                                        </span>
                                        <span>Add Discount on Product</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive" style="padding: 30px 18px;">
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                ...
                                <tbody>
                                    ...
                                    $stmt = "SELECT id,category,currency,dis_type,value_per,start_date,end_date,created_at FROM `discount_order` WHERE discount_order.deleted_at IS NULL ORDER BY created_at DESC";
                                    ...
                                    ?>
                                            <tr class="text-center" >
                                                ...
                                                <td>
                                                    <form action="./edit_discount_product.php" method="post">
                                                ...
                                                <td>
                                                    <form onsubmit="return confirm_delete()" action="../../backend/user/delete_discount_product.php" method="post">
                                                        <input type="number" name="id" value="<?php echo $row["id"]; ?>" hidden>
