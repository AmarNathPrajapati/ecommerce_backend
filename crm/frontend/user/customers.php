                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-4">Customers Details</h1>
                            </div>
                            <!-- Actions -->
                        ...
                        <div class="table-responsive" style="padding: 30px 18px;">
                            <table class="table table-hover table-nowrap" id="myTable" style="border: 0px solid black !important; padding: 30px 2px;">
                                ...
                                <tbody>
                                    ...
                                    $stmt = "SELECT id,name,email,phone,created_at FROM customers WHERE customers.deleted_at IS NULL AND customers.archive=(?)";
