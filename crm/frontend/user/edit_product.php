                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-7 p-sm-5">
                        <div class="form-box px-sm-5 mb-5">
                            <form class="px-sm-5" action="../../backend/user/edit_product.php" onsubmit="return showloader()" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Case Study Title" required class="form-control" id="name" name="title" value="<?php echo $_POST["title"]; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Product Description</label>
                                    <textarea type="text" placeholder="Case Study Description" required class="form-control" id="description" name="description"><?php echo $_POST["description"]; ?></textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select name="currency" id="currency">
                                        ...
                                        if ($result) {
                                            $data = mysqli_stmt_get_result($sql);
                                            while ($row = mysqli_fetch_array($data)) {
                                                if ($_POST["currency"] == $row['service_name'])
                                                    continue;
                                        ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="marketing_angle" value="<?php echo $_POST["marketing_angle"]; ?>" type="text" placeholder="Marketing Angle" required class="form-control" id="name">
                                </div>
