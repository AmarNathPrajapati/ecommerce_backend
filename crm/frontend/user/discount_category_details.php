                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-3">Discount Details on Category</h1>
                            </div>
                            <!-- Actions -->
                        ...
                        <div class="form-box px-sm-5 mb-5">
                            ...
                            onsubmit="return showloader()" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input readonly type="text" placeholder="Product Title" required class="form-control" id="name" name="dis_per" 
